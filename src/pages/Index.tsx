      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto w-full">
          <AnimatedSection>
            ...
            >
              <img src={mjwLogo} alt="MJW GROUP" className="h-24 md:h-32 object-contain drop-shadow-2xl" />
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/platforms" className="btn-gold-mjw">
      ...
      <section id="apps" className="relative py-32 px-6 overflow-hidden bg-background">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { logo: vaultaLogo, name: "Vaulta", sub: "Family Health Coordination", desc: "Secure platform for managing family medical records, emergency contacts, care plans, and health documentation — built for real family health administration." },
              { logo: ledgeraLogo, name: "Ledgera", sub: "Financial Operations", desc: "Financial operations platform for South African owner-managed businesses. VAT calculations, tax structuring, expense tracking, and audit-ready reporting." },
              { logo: sitemarkLogo, name: "Sitemarka", sub: "Property Field Inspection", desc: "Site-level inspection and reporting system for property operations. Tracks real-world execution, compliance logs, and field-level operational data." },
            ].map((a, i) => (
                  ...
                  <div className="relative" style={{ background: "#0a0a0c" }}>
                    ...
                    <div className="music-thumb-overlay">
                      <div className="play-btn-gold">
                        <svg width="18" height="18" fill="black" viewBox="0 0 24 24" style={{ marginLeft: 2 }}>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <AnimatedSection className="order-1 lg:order-2" delay={0.15}>
              ...
              <p className="text-white/38 text-sm leading-relaxed mb-8 max-w-md">
                ...
                For families, primary caregivers, and individuals who need a clear operating framework
                during periods of crisis, transition, or sustained care responsibility.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://a.co/d/0ftxdKNU"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <AnimatedSection>
              ...
              <Link to="/founder" className="group text-[#C9A961] text-sm font-semibold inline-flex items-center gap-1.5 hover:gap-2.5 transition-all">
                Read Founder Profile <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
              </Link>
            </AnimatedSection>

            {/* Photo + How We Build */}
            <AnimatedSection delay={0.2} className="space-y-5">
              <div className="rounded-3xl overflow-hidden gradient-border">
                <img
                  src={founderPhoto}
                  alt="Mornay Walters — Founder MJW GROUP"
                  className="w-full object-cover object-top"
                  style={{ maxHeight: 340, filter: "grayscale(15%) contrast(1.05)" }}
                  onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }}
                />
              </div>

              <div className="gradient-border rounded-3xl p-8" style={{ background: "linear-gradient(135deg,#18181c,#09090c)" }}>
                <p className="text-[9.5px] text-[#C9A961] tracking-[0.38em] uppercase font-semibold mb-5">— How We Build</p>
                <div className="section-divider-gold mb-7" />
                <p className="text-[9.5px] text-white/25 tracking-[0.28em] uppercase mb-7">No venture capital. No growth-at-all-costs pressure.</p>
                <div className="space-y-6">
                  {[
                    ...
                    <div key={item.title} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-serif font-bold mb-1 text-sm">{item.title}</h4>
          ...
          >
            ...
            <label className="flex items-start gap-3 mb-6 cursor-pointer">
              ...
              <span className="text-xs text-white/35 leading-relaxed">
                I consent to receiving the MJW Newsletter and can unsubscribe at any time.
              </span>
            </label>
            ...
            <p id="subSuccess" className="hidden text-center text-[#C9A961] text-xs mt-4 tracking-wider" style={{ display: "none" }}>
