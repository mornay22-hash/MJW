      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            <img src={mjwLogo} alt="MJW GROUP" className="h-14 w-auto object-contain" />
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            <Link to="/platforms" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Platforms</Link>
            <Link to="/founder" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Founder</Link>
            <a href="#music" onClick={(e) => { e.preventDefault(); document.getElementById("music")?.scrollIntoView({ behavior: "smooth" }); }}
              className="text-sm text-muted-foreground hover:text-foreground transition-colors cursor-pointer">Music</a>
            <a href="#books" onClick={(e) => { e.preventDefault(); document.getElementById("books")?.scrollIntoView({ behavior: "smooth" }); }}
              className="text-sm text-muted-foreground hover:text-foreground transition-colors cursor-pointer">Books</a>
